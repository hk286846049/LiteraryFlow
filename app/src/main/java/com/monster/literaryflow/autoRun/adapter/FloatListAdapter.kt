...
class FloatListAdapter(private val dataList: List<AutoInfo>) : RecyclerView.Adapter<FloatListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_float_list, parent, false)
