...
import com.monster.literaryflow.floatwindow.ProgressRing
import com.monster.literaryflow.floatwindow.Timer
...
class MainActivity2 : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.tvD).setOnClickListener { _->
            Intent(this@MainActivity2, SideWindowActivity::class.java).let {
                startActivity(it)
            }
        }
        ...
        findViewById<Button>(R.id.btnMaskWindow).setOnClickListener {
            ...
            maskWindowInfo = FloatWindow.WindowInfo(view).apply {
                width = DimensionUtil.getScreenWidth(this@MainActivity2)
                height = DimensionUtil.getScreenHeight(this@MainActivity2)
            }
        ...
        findViewById<Button>(R.id.btnNormal).setOnClickListener {
            Toast.makeText(this@MainActivity2,"globalMask",Toast.LENGTH_LONG).show()
        }
